...
urlpatterns = [
    ...
    path('overlappingareas/', views.overlapping_areas, name='overlapping_areas'),
    path('openapi', get_schema_view(title="Mozio gelocation system", version="1.0.0"), name='openapi-schema'),
